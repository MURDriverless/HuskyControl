...
int main(int argc, char **argv) {
    ...
    std::ifstream iConfig("/home/micah/Documents/Husky/src/HuskyControl/husky_mpcc/src/Params/config.json");
    json jsonConfig;
    iConfig >> jsonConfig;
    ...
    BoundsParam boundParam = BoundsParam((std::string)jsonConfig["bounds_path"]);
